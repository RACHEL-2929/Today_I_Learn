...
public class Application01 {
    public static void main(String[] args) {
        ...
        * 유연성 확보는 여러 곳에 적용될 수 있는 유연한 객체를 의미하며, 즉 재사용이 높아질 수 있게 한다는 의미이다
        * 객체의 재사용이 증가하면 중복 작성되는 코드를 줄일 수 있으며, 오류 발생 가능성을 감소시키고 유지보수성을 증가시킨다.
        * */
        ...
        * 메세지를 수신하는 쪽을 수신자 라고 한다. 수신자는 메시지를 전달 받아 그 메시지에 내용을 처리하는 방법을
        * 스스로 결정하고, 그 결정한 방법 대로 처리할 명령어들을 순차적으로 기술한 것을 메소드라고 한다
        * 상호작용에 중요한 것은 메시지를 송수신하고 그 방법을 기술하여 메세지에 응답하는 상호작용을 설계하는 것이다.
        * 따라서 객체를 설계할 때는 속성은 부가적이며 적절한 책임을 가진 객체들간의 주고 받는 메세지를 이용해 상호작용하는
        * 것을 설계하는 것을 의미한다
        ...
        * 2. 자동차는 시동 걸기, 앞으로 가기, 멈추기, 시동끄기를 할 수있다
