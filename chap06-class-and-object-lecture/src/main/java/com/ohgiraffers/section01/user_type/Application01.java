...
public class Application01 {
    public static void main(String[] args) {
        ...
        /*이렇게 각각의 변수로 관리하게 되면 여러가지 단점이 생긴다
         * 1. 변수명을 다 관리해야 하는 어려움이 있다
         * 2. 모든 회원 정보를 인자로 메소드 호출 시 전달하면 너무 많은 값들을 인자로 전달해야 하기에 한 눈에 안 들어온다.
         ...
         * 사용자 정의의 자료형인 클래스를 이용하기 위해서는 new 연산자로 heap 에 할당을 해야 한다.
         * 객체를 생성하게 되면 클래스에 정의한 필드와 메소드 대로 객체(instance) 가 생성된다.
         * 아이디, 비번, 이름, 나이. 성별, 취미 를 연속된 메모리 주소에서 사용하도록 heap 에 공간을 만들었다
         * */
         ...
         * "." 은 참조연산자 라고 하는데, 레퍼런스 변수가 참고하고 있는 주소로 접근한다는 의미 가짐
